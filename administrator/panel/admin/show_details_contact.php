...
<head>
    ...
    <title>نمایش دیتاهای مربوط به نظرات کاربران</title>
    <!--  link css -->
    ...
    <section class="data">
        ...
        <section class="row m-0">
            <section class="col-8 offset-2 jumbotron bg-dark text-white text-center p-4 mt-5">
                <h4 class="text-center mb-4 mt-2" style="color: #a7a7ff">صفحه نمایش نظرات کاربران</h4>
                <table class="table table-bordered table-hover table-responsive-xl table-dark">
                    ...
                    <?php foreach ($query as $item): ?>
                        <tr class="text-white" style="font-size: 15px">
                            ...
                            <!--<td>< ?php echo substr($item['comment'], 0, 50); ?></td>  // 1)name 2)min  3)max-->
